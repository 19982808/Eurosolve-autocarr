document.addEventListener("DOMContentLoaded", () => {
  ...
  if (heroBtn) {
    heroBtn.addEventListener("mouseenter", () => heroBtn.style.transform = "scale(1.05)");
  ...
  /* ================= OPTIONAL: MODALS OR FORM INTERACTIONS ================= */
  // Example: you can add form submission handling or popups here
